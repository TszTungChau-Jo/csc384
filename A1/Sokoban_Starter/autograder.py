...
def test_alternate_simple():
    ...
    print("\n*************************************")
    print("Of {} problems, {} were solved in less than {} seconds by this solver.".format(1, solved,
                                                                                        timebound))
    print("Problems that remain unsolved in the set are Problems: {}".format(unsolved))
    print("*************************************\n")
    ##############################################################
...
def test_all():
    ...
    #if test_alternate_simple: test_alternate_simple()
